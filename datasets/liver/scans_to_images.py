...
scans_directory = '/home/liaoheng/dataset/LiTS17/liver/scan/'
...
for folder in subfolders:
  ...
  for scan_files in all_files:
    ...
    for i in range(mask_scan.shape[-1]):
      ...
      # volume_slice = cv.resize(volume_slice, dsize=(448, 448), interpolation=cv.INTER_CUBIC)
      # mask_slice = cv.resize(mask_slice, dsize=(448, 448), interpolation=cv.INTER_CUBIC)
